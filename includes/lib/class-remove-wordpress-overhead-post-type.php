...
use Remove_Wordpress_Overhead\Remove_Wordpress_Overhead_Post_Type;

if ( ! defined( 'ABSPATH' ) ) exit;

class Remove_Wordpress_Overhead_Post_Type {
	...
	public function register_post_type () {
		...
		$labels = array(
			...
			'add_new' => _x( 'Add New', $this->post_type , 'remove-wordpress-overhead' ),
			...
			'new_item' => sprintf( __( 'New %s' , 'remove-wordpress-overhead' ), $this->single ),
			...
			'not_found_in_trash' => sprintf( __( 'No %s Found In Trash' , 'remove-wordpress-overhead' ), $this->plural ),
